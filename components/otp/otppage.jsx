...
const OtpPage = ({ phonenumber, setIsOtpVarified, SetIsOtpSucess }) => {
  const [otp, setOtp] = useState("");


  const sendOtp = async () => {
    console.log('OTP Page Update Phone number ------------>>>>>', phonenumber)
    try {
    ...
    <>
      <div className="w-full">
        <div className="grid place-items-center lg:pt-28 md:pt-26 sm:pt-20 xs:pt-15">
          ...
          <p className="text-gray-500 font-semibold pt-4">+88 {phonenumber}</p>
        </div>
