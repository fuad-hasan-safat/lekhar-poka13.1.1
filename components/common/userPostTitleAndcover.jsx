      ...
      <div className="profile__auth__wrap space-x-[15px]">
        ...
        <div className="hm__post__profile__grid  relative">
          ...
          <span className='inline-block mr-[10px]'>
            <img className="lg:w-[24px] lg:h-[24px] md:w-[22px] md:h-[22px] sm:w-[20px] sm:h-[20px] xs:w-[18px] xs:h-[18px] rounded-full block m-auto shadow-lg" src={writerImage === '' ? defaultBannerImage : `${apiBasePath}/${writerImage}`} alt="" />
          </span>
