...
import { audioList } from '../../components/AudioBook/components/sampleData/samprotikData'; 



const SeeMoreList = () => {

    const audioData = audioList.data;
        ...
        <>
            ...
            <section className="banner-sec-wrap">
                <div className="relative w-full xl:h-[380px] lg:h-[360px] md:h-[340px] sm:h-[280px] xs:h-[260px]  overflow-hidden" style={{ background: `url('/images/pages-banner-svg/baseBanner.png')center center / cover no-repeat` }}>
                    <h2 className=" absolute top-[50%] left-[50%] text-[40px] text-[#F9A106] -translate-x-[50%] -translate-y-[50%] max-h-[0px]">{audioList.category}</h2>
                </div>
            </section>
